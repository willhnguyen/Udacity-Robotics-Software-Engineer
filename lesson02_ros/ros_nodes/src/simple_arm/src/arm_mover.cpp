...
std::vector<float> clamp_at_boundaries(const float requested_j1, const float requested_j2)
{
    ...
    // Check if joints falls in the safe zone, otherwise clamp them
...
// This callback function executes ahwnever a safe_move service is requested
...
int main(int argc, char** argv)
{
    ...
    // Define two publishers to publish std_msgs::Float64 messages on joints respective to topics
